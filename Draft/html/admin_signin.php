...
<head>
    <meta charset="UTF-8">
    <title>Admin Sign In | LOFT &amp; LIVING</title>
    ...
    <style>
        ...
        html.dark-mode .auth-card { background-color: #242424; border-color: #444; }
        html.dark-mode .form-group input { background-color: #1a1a1a; border-color: #444; color: #e0e0e0; }
