...
<body data-category="bathroom">
    ...
    <div style="max-width: 800px; margin: 40px auto 50px; text-align: center; padding: 0 40px;">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 32px; font-weight: 600; margin-bottom: 20px; color: #2B2B2B; letter-spacing: 1px;">BATHROOM</h1>
        <p style="font-family: 'Ibarra Real Nova', serif; font-size: 16px; line-height: 1.7; color: #2B2B2B; font-weight: 400;">Transform your bathroom into a spa-like retreat with our elegant collection. From modern vanities and luxurious towels to stylish storage solutions and premium fixtures, find everything to create your perfect bathroom oasis.</p>
    </div>
    ...
    <div class="content-wrap">
        <aside class="side-bar">
            ...
            <div class="tags">
                ...
                <input type="checkbox" id="spa-tag" value="spa" hidden>
                <label for="spa-tag" class="tag">Spa<span class="X">✕</span></label>
                <input type="checkbox" id="minimalist-tag" value="minimalist" hidden>
                <label for="minimalist-tag" class="tag">Minimalist<span class="X">✕</span></label>
            </div>

            <h3>Categories</h3>
            <label><input type="checkbox" class="category-filter" value="vanities"> Vanities</label>
            ...
            <label><input type="checkbox" class="colour-filter" value="chrome"> Chrome</label>

            <h3>Size</h3>
            <label><input type="checkbox" class="size-filter" value="small"> Small</label>
            <label><input type="checkbox" class="size-filter" value="medium"> Medium</label>
...
<?php
    ...
    <script type="module" src="../javascript/bathroom-js/filters.js"></script>
    <script type="module" src="../javascript/bathroom-js/sorting.js"></script>
    <script type="module" src="../javascript/bathroom-js/price-range.js"></script>
    <script type="module" src="../javascript/bathroom-js/search.js"></script>
</body>
</html>
