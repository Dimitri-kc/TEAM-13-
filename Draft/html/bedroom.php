...
<a href="../html/homepage.php" style="text-decoration: none; color: inherit;">
  <h1 class="page-hero-title">BEDROOM</h1>
</a>
<p class="page-hero-intro">Your bedroom should be a peaceful retreat designed for rest and relaxation. Our Bedroom collection includes stylish bed frames, bedside tables, comfortable footstools, decorative wall art, and warm lighting to create a cosy and modern sleeping space. Each piece is designed to combine comfort, simplicity, and contemporary design, helping you build a bedroom that feels both calm and elegant.</p>
