...
<head>
    ...
    <style>
        ...
        /* background image for dark mode handled in centralized CSS (logo/other dark tweaks kept below) */
...
<body data-category="office" class="<?php echo $isAdmin ? 'admin-session-active' : ''; ?>">
    <?php if ($isAdmin): ?>
