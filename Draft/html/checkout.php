...
/*
  FIX: Checkout totals were not updating because basket data is stored in PHP session,
  while checkout page was relying on JS. Compute totals in PHP from the same session cart.
*/

// same cart selection logic as your basket.php
...
$subtotal = 0.0;
$delivery = 0.0; // keep as 0 unless you implement delivery rules
$total = 0.0;
...
<head>
    ...
    <!-- ONLY FIXES ASKED -->
    <style>
        /* Remove the oval bin (basket count badge) */
        #basket-count { display: none !important; }

        /* Put order details (basket/summary) on the left */
        .checkout-layout { display: flex !important; }
        .product-column { order: 1 !important; }
        .details-column { order: 2 !important; }

        /* Remove product images (in case anything renders them) */
        .product-column img,
        #basket-items-container img { display: none !important; }

        /* Replace submit background with #ccc */
...
<main class="checkout-layout">
    ...
    <!-- Order details LEFT + Total price at top of checkout section -->
    <aside class="product-column">

        <!-- Remove product details fully (no item cards) -->
    ...
    <section class="details-column">
        ...
        <form method="post" id="checkout-form">
            ...
            <!-- Split sections: Details → Address → Card details -->
            ...
            <div class="card-fields">
                ...
                <!-- Add a button to view basket + Total above the checkout -->
                ...
                <!-- Remove the checkout container and replace submit with checkout -->
...
<!-- checkout.js removed because totals now come from PHP session cart -->
