...
<body data-category="kitchen">
    ...
    <div style="max-width: 800px; margin: 40px auto 50px; text-align: center; padding: 0 40px;">
        <h1 style="font-family: 'Playfair Display', serif; font-size: 32px; font-weight: 600; margin-bottom: 20px; color: #2B2B2B; letter-spacing: 1px;">KITCHEN</h1>
        <p style="font-family: 'Ibarra Real Nova', serif; font-size: 16px; line-height: 1.7; color: #2B2B2B; font-weight: 400;">Elevate your culinary space with our premium kitchen collection. From contemporary dining sets and bar stools to elegant storage solutions and stylish accessories, discover everything you need to create a kitchen that's both functional and beautiful.</p>
    </div>
    ...
    <div class="content-wrap">
        <aside class="side-bar">
            ...
            <div class="tags">
                ...
                <input type="checkbox" id="contemporary-tag" value="contemporary" hidden>
                <label for="contemporary-tag" class="tag">Contemporary<span class="X">✕</span></label>
                <input type="checkbox" id="rustic-tag" value="rustic" hidden>
                <label for="rustic-tag" class="tag">Rustic<span class="X">✕</span></label>
            </div>

            <h3>Categories</h3>
            <label><input type="checkbox" class="category-filter" value="dining-sets"> Dining Sets</label>
            <label><input type="checkbox" class="category-filter" value="bar-stools"> Bar Stools</label>
...
<?php
  ...
  <script src="../javascript/global/basketIcon.js"></script>
    ...
    <script type="module" src="../javascript/kitchen-js/search.js"></script>
</body>
</html>
