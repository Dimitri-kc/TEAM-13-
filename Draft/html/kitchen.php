...
<head>
    ...
    <style>
        ...
        body {
            ...
            font-weight: 100;
            line-height: 1.6;
            background-image: linear-gradient(rgba(255, 255, 255, 0.82), rgba(255, 255, 255, 0.82)), url("../images/kitchen-images/kitchen-back.jpeg");
        ...
        html.dark-mode body[data-category="kitchen"] {
            background-image: linear-gradient(rgba(10, 10, 10, 0.74), rgba(10, 10, 10, 0.74)), url("../images/kitchen-images/kitchen-back.jpeg");
        }
...
<body data-category="kitchen">
    ...
    <a href="../html/homepage.php" style="text-decoration: none; color: inherit;">
        <h1 class="page-hero-title">KITCHEN</h1>
    </a>
    <p class="page-hero-intro">The kitchen is where everyday moments happen, from quick breakfasts to shared meals with friends and family. Our Kitchen collection offers modern dining tables, stylish chairs, practical storage solutions, lighting, and dining sets designed to make your space both functional and welcoming. With a focus on modern design and everyday usability, these pieces help create a kitchen that feels organised, stylish, and inviting.</p>
