...
2.	Level 1 Dependencies:
  ...
  - basket (Requires users)
  - basket_items (Requires basket and products)
3.	Level 2 Dependencies:
  - orders (Requires users)
  - order_items (Requires orders and products)
  - payments (Requires orders and users)
4.	Level 3 Dependencies:
  - returns (Requires order_items and users)
  - return_items (Requires returns and products)
  - reviews (Requires products and users)
